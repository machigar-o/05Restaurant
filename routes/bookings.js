...
*         restaurant:
*           type: string
*           description: ID of the restaurant being booked
*         createdAt:
*           type: string
*           format: date
*           example: '2023-08-20'
...
*           type: string
*         required: false
*         description: The restaurant id (Optional)
*     responses:
*       200:
...
*     security:
*       - bearerAuth: []
*     summary: Create a new Booking for the restaurant specified by restaurant id
*     tags: [Bookings]
*     parameters:
*       - in: path
*         name: restaurantId
